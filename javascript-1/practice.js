...
// Create a function called 'lovesCodeChecker' that takes in a single parameter called 'x'. Check to see if 'x' is equal to true. If it is, return a true boolean. If 'x' does not equal true, 
...
//key should be your name as a string. The value of the property state should be your current state or providence of residence 
//as a string. The value of age should be your age as a number. greeter should be a method that returns the string 'Hello! My 
//name is NAMEVALUE and I live in STATEVALUE' with the corresponding values. 
...
// Code Here
const filtered = myNumbers.filter((element) => {if(element > 100){return element}})
//////////////////PROBLEM 16////////////////////
...
// Code Here
const total = myNumbers.reduce((acc, element) => {return acc + element}, 0)
//////////////////PROBLEM 17////////////////////
...
// Code Here
const myNumbersIndex = myNumbers.forEach(function(element) {
	return myNumbersIndex.push(element)
})
//////////////////PROBLEM 18////////////////////

// Did you know that George Foreman has five sons named George? Go ahead and change everyone's name in the notGeorge array to 
//George using .map. Store the resulting array in a variable named 'forTheLoveOfGeorge'.
const notGeorge = ['Louis', 'Ted', 'Bill', 'Sharon', 'Mark', 'Angela']

// Code Here
let forTheLoveOfGeorge = notGeorge.map(function(element){
	return notGeorge.splice(1,0,'George')
})
//////////////////PROBLEM 19////////////////////
...
let enemies = people.filter((element) => {
	if(element.friend = false){
		return enemies.push(element.friend)
	}
})
//////////////////PROBLEM 20////////////////////
